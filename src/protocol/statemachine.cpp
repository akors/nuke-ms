...
public:
    ...
    virtual byte_traits::byte_sequence& getPayload() throw()
    { return payload; }

    virtual const byte_traits::byte_sequence& getPayload() const  throw()
    { return payload; }
};
